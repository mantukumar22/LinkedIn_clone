                                            ...
                                            <div>
                                                <div style={{ display: "flex", gap: "1.2rem", justifyContent: "space-between" }} >
                                                    ...
                                                    {post.userId._id === authState.user.userId._id &&
                                                        <div onClick={async () => {
                                                            ...
                                                            <svg style={{ height: "1.3em", color: "red", cursor: "pointer" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                ...
                                                <div className={styles.optionsContainer} >
                                                    ...
                                                    <div onClick={() => {
                                                        ...
                                                        const url = encodeURIComponent("amritguru.in");
