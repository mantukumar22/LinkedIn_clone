...
3. installing dependcies :
    npm install bcrypt cors crypto express mongoose multer nodemon  pdf-creator-node pdfkit 
...
1. using this : npx create-next-app@latest
    with  
...
2.  installing react redux {npm install react-redux}
    and this : npm i @reduxjs/toolkit
    and npm i axios
3. create src/config/index.jsx then backend url setup there
4. then create src/cofig/redux/action,middleware,reducer,store.js
